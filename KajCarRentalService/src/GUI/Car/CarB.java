 ...
 * @author agnarsdottir
 */
public class CarB extends javax.swing.JFrame
{

    /**
     * Creates new form CarB
     */
    public CarB()
    {
        initComponents();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(CarB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
