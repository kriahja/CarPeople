 ...
 * @author agnarsdottir
 */
public class CatB extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(CatB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
