 ...
 * @author agnarsdottir
 */
public class CatA extends WindowCtrl
{
    CatJFrame cat;
    /**
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(CatA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
